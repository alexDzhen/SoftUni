...
public class Robotics {
    public static void main(String[] args) {
        ...
        while (!products.isEmpty()) {
            ...
            decreaseProcestime(processTimes);
    ...
    private static void decreaseProcestime(int[] processTimes) {
    ...
    private static void logJobAssigned(String key, String name, long totalSeconds) {
        long hours = (totalSeconds / 3600) % 24;
        long minutes = (totalSeconds % 3600) / 60;
        long seconds = totalSeconds % 60;
        System.out.println(String.format("%s - %s [%02d:%02d:%02d]", key, name, hours, minutes, seconds));
    }
